...
describe RecordingJobs::FindBrokenRecordings do
  let(:video) { create(:recording_published, hls_main: '/1/playlist.m3u8') }
  ...
  context 'when given id' do
    ...
    context 'when video hls_url is empty' do
      let(:video) { create(:recording_published, hls_main: nil) }

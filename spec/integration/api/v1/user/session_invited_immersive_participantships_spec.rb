...
describe 'Session Invited Immersive Participantships', swagger_doc: 'api/v1/swagger.json' do
  path '/api/v1/user/session_invited_immersive_participantships' do
    get 'Get invited participantships' do
      tags 'User::SessionInvitedImmersiveParticipantships'
  ...
  path '/api/v1/user/session_invited_immersive_participantships/{id}' do

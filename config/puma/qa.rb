...
pid = "#{app_path}/tmp/pids/puma.pid"
stderr_path = "#{app_path}/log/puma.log"
stdout_path = "#{app_path}/log/puma.log"
sock_path = "unix:#{app_path}/tmp/sockets/puma.sock"
...
#   Rails.cache.instance_variable_get(:@data)._client.disconnect
#   Resque.redis._client.disconnect
# end

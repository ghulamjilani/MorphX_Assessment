...
CONF=/opt/bitnami/mongodb/prod_conf/router.conf
DAEMON=/opt/bitnami/mongodb/bin/mongos
PIDFILE=/opt/bitnami/mongodb/tmp/mongodb-router.pid
PORT=27117 # This must be the same port as specified in the $CONF file

...
Rails.application.configure do
  config.before_configuration do
    Rails.application.instance_variable_set(:@credentials, OverCreds.new('qa').config)
  end
  ...
  logger           = ActiveSupport::Logger.new(Rails.root.join('log', "qa.#{`hostname`.to_s.strip}.log"))

...
class OrganizationCover < ActiveRecord::Base
  ...
  mount_uploader :image, CompanyCoverUploader
  ...
  def image_dimensions_and_size_validity
    ...
    begin
      ...
      if magick_image.width < 415 || magick_image.height < 115
        errors.add(:image, "Image #{image.file.original_filename} should be 415x115 minimum")
      end

...
import FfmpegserviceWebRTCPlay from './lib/FfmpegserviceWebRTCPlay.js';
...
const init = (errorHandler,connected,stopped) => {
  initListeners();
  window.ffmpegserviceWebRTCPlay = new FfmpegserviceWebRTCPlay();
  ffmpegserviceWebRTCPlay.on({
...
const start = (settings) => {
  update(settings).then(() => {
    ffmpegserviceWebRTCPlay.play();
  });
}

const stop = () => {
  ffmpegserviceWebRTCPlay.stop();
}
...
const update = (settings) => {
  ...
  return ffmpegserviceWebRTCPlay.set(sendSettings);
}

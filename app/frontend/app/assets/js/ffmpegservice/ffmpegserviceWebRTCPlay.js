...
import { mungeSDPPlay } from './FfmpegserviceMungeSDP.js';
import FfmpegservicePeerConnectionPlay from './FfmpegservicePeerConnectionPlay.js';

class FfmpegserviceWebRTCPlay
{
  constructor (props) {
    this.state = {
    ...
    this.ffmpegservicePeerConnectionPlay = undefined;
    this.callbacks = {};
    this.newAPI = false;
  ...
  getAvailableStreams(){
    ...
    this.ffmpegservicePeerConnectionPlay = new FfmpegservicePeerConnectionPlay({
    ...
    return (this.ffmpegservicePeerConnectionPlay.getAvailableStreams());
  }
  ...
  play(){
    ...
    this.ffmpegservicePeerConnectionPlay.start();
  }

  stop()
  {
    this.ffmpegservicePeerConnectionPlay.stop();
    this.ffmpegservicePeerConnectionPlay = undefined;
  }

  errorHandler(error){
    console.log('FfmpegserviceWebRTCPlay ERROR:');
    console.log(error);
...
export default FfmpegserviceWebRTCPlay;

...
class FfmpegservicePeerConnectionPlay
{
  constructor (props)
  {
    // munge plug-in
  ...
  {
    let _this = this;
    console.log('FfmpegservicePeerConnectionPlay.gotDescription');
  ...
  {
    let _this = this;
    console.log('FfmpegservicePeerConnectionPlaywsConnect: ' + url);
    ...
    {
      console.log("FfmpegservicePeerConnectionPlay.onopen");
  ...
  start ()
  {
    ...
    if (this.peerConnection == null) {
      console.log("FfmpegservicePeerConnectionPlay.start: sdpURL:" + this.sdpURL + " streamInfo:" + JSON.stringify(this.streamInfo));
      this.wsConnect(this.sdpURL);
    }
    else {
      console.log('FfmpegservicePeerConnectionPlay.start: peerConnection already in use, not starting');
    }
  }
  ...
  getAvailableStreams ()
  {
    ...
    return new Promise((resolve,reject) => {
      ...
      if (_this.peerConnection == null) {
        ...
        reject({message:"FfmpegservicePeerConnectionPlay.getAvailableStreams: peerConnection already in use"})
      }
    });
  }
...
export default FfmpegservicePeerConnectionPlay;

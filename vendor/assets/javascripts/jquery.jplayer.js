 ...
 */
//REPLACE IT CAREFULLY! Modified for Immerss needs by Ivan @intale
(function (root, factory) {
    ...
    $.jPlayer.prototype = {
        ...
        options: { // Instanced in $.jPlayer() constructor
            swfPath: "/jplayer", // Path to Jplayer.swf. Can be relative, absolute or server root relative.
        ...
        _cssSelector: function(fn, cssSel) {
            ...
            if(typeof cssSel === 'string') {
                if($.jPlayer.prototype.options.cssSelector[fn]) {
                    ...
                    if(_.isObject(this.options.cssSelectorAncestor)){
                        //Handle cssSelectorAncestor as jQuery object.
                        this.css.cs[fn] = this.options.cssSelectorAncestor.find(cssSel);
                    }else{
        ...
        _fullscreenchange: function() {
            ...
            if(this.options.fullScreen && !$.jPlayer.nativeFeatures.fullscreen.api.fullscreenElement()) {
                this._setOption("fullScreen", false);
                $("body").removeClass("jplayer-fullscreen");
            }else{
                $("body").addClass("jplayer-fullscreen");
            }
        },

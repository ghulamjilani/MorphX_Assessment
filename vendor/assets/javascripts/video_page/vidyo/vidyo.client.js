...
(function (window) {
    ...
    var vidyoClient = function (config) {
        ...
        var getSupportedPluginMimeTypes = function () {
            var retVal = [
                "application/x-vidyoweb-1.3.6.00000",
                "application/x-vidyoweb-1.3.6.99999"
            ];
            return retVal;
        };
        ...
        var sendEvent = function (event, callback) { /* Callback is optional */
            ...
            try {
                if (proxyWrapper.isChrome) {
                    proxy.sendEvent(event, function (request) {
                        if (callback) {
                            callback(request);
                        }
                    });
    ...
    window.vidyoClient = vidyoClient;
    return window.vidyoClient;
})(window);

...
(function (window) {
    ...
    var _getCurrentTime = function () {
        ...
        return _padString((currentdate.getMonth() + 1).toString(), 2, '0') + "/"
    ...
    var _getStack = function () { // looked up at http://stackoverflow.com/questions/4671031/print-function-log-stack-trace-for-entire-program-using-firebug
        ...
        if (!isCallstackPopulated) { //IE and Safari
            var currentFunction = _getStack.caller; // This is violation of strict mode of ES5, but the use case is valid
            var fn;
            var fname;

...
(function (window) {
    ...
    var vidyoClientMessages = {
        ...
        'requestConfiguration': function (type, params) {
            ...
            that.microphoneVoiceProcessingSupport = params && params.microphoneVoiceProcessingSupport || [1];
    ...
    window.vidyoClientMessages = vidyoClientMessages;
    return window.vidyoClientMessages;
})(window);

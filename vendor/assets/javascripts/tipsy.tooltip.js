            ...
            if (title && this.enabled) {
                ...
                switch (gravity.charAt(0)) {
                    ...
                    case 'w':
                        ...
                        break;
                    case 'z':
                        tpLeft = {top: pos.top + pos.height + this.options.offset + 10, left: pos.left + pos.width / 2 - ((actualWidth + 16) / 2)};
                        tp = tpLeft;
                        break;
                }
                if(gravity == 'z'){
                    jQuery('.tipsy-arrow.tipsy-arrow-z').css('left', (pos.left - tp.left) - ((pos.width / 2 ) + 2 ) + 'px')
                    if(tp.left <= 0){
                        tp = {top: pos.top + pos.height + this.options.offset ,left:5}
                    };
               ...
               $tip.hover(set_hovered(true), set_hovered(false));
                var diff = tp.left - pos.left;
                var coefficient = 16;
                var tooltipArrowPosition = (pos.width / 2) - diff - coefficient;
                //console.log('center: ' + (pos.width / 2) - (tp.width / 2), pos.width, tpLeft);
                if(gravity == 'z'){
                    if(tp.left <= 0){
                        tp = {top: pos.top + pos.height + this.options.offset ,left:5}
                        jQuery('.tipsy-arrow.tipsy-arrow-z').css('left', (pos.left - tp.left) - ((pos.width / 2 ) + 2 ) + 'px');
                        ...
                        jQuery('.tipsy-arrow.tipsy-arrow-z').css('left', tooltipArrowPosition);
                    }
                }
            }
        },
